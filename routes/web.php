...
Route::prefix('/admin')->group(function(){
    ...
    //课程锁定
    Route::any('coursecheckdel','Admin\TeacherController@coursecheckdel');

    //课程章节列表
    Route::any('teacher/sectionlist','Admin\TeacherController@sectionlist');
    //课程章节审核通过
    Route::post('sectioncheckok','Admin\TeacherController@sectioncheckok');
    //课程章节审核不通过
    Route::any('sectioncheckno','Admin\TeacherController@sectioncheckno');
    //课程章节锁定
    Route::any('sectioncheckdel','Admin\TeacherController@sectioncheckdel');

    //课时管理
    Route::any('teacher/periodlist','Admin\TeacherController@periodlist');   //课时列表
    Route::any('periodcheckok','Admin\TeacherController@periodcheckok');   //课时列表
    Route::any('periodcheckno','Admin\TeacherController@periodcheckno');   //课时列表
    Route::any('periodcheckdel','Admin\TeacherController@periodcheckdel');   //课时列表
    ...
    Route::any('index/suser','Admin\IndexUserController@suserlist');  //前台用户列表
    Route::any('index/suserdel','Admin\IndexUserController@suserdel');  //前台用户锁定
