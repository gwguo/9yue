...
<div class="coursecont">
    ...
    <div class="coursepic">
        <div class="course_img"><img src="{{$v->c_img}}" width="500"></div>
        <div class="coursetitle">
            <a class="state">更新中</a>
            <h2 class="courseh2">{{$v->c_name}}</h2>
            <p class="courstime">总课时：<span class="course_tt">30课时</span></p>
            <p class="courstime">课程时长：<span class="course_tt">3小时20分</span></p>
            <p class="courstime">学习人数：<span class="course_tt">{{$v->c_number}}人</span></p>
            ...
            <span class="coursebtn"><a class="btnlink" href="/information/buycoursecont?id={{$v->c_id}}">购买课程</a><a class="codol fx" href="javascript:void(0);" onClick="$('#bds').toggle();">分享课程</a><a class="codol sc" href="#">收藏课程</a></span>
