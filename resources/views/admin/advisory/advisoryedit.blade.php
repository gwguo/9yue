    ...
    <form class="layui-form layui-form-pane" action="" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="a_cate_name" value="{{$a_cate_name}}" required  lay-verify="required" placeholder="请输入资讯分类" autocomplete="off" class="layui-input">
                <input type="hidden" name="a_cate_id" value="{{$a_cate_id}}">
            </div>
        </div>
        <div class="layui-form-item">
